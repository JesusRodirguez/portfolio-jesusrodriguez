  ...
  return (
    <div className="bg-white text-black min-h-screen">
      ...
      <div className="p-6 max-w-5xl mx-auto">
        <h1 className="text-3xl font-bold text-center mb-6">Gestión de Eventos</h1>
        ...
        >
          ...
          <button
            type="submit"
            className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded mr-2 cursor-pointer transition-all sm:col-span-2"
          >
